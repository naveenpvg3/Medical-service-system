...
if(isset($_POST['submit'])){
	...
	//if(empty($_POST['username']) or empty($_POST['password']) or  empty($_POST['password']) 
	...
	<div class="row">
	    ...
	    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
			<form role="form" method="post" action="" autocomplete="off">
				...
				<p>Already a member? <a href='login.php'>Login</a>				<a href="index.html">
<img src="image.png" alt="" width="42" height="40" border=""></a></p>
				...
				if(isset($_GET['action']) && $_GET['action'] == 'joined'){
					echo "<h2 class='bg-success'>Registration successful, Please log in to access the services.</h2>";
				}
				?>
